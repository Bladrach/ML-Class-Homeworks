...
X1, y1 = make_blobs(n_samples=150, centers=4, n_features=2,random_state=37)
X2, y2 = make_gaussian_quantiles(mean=(9,7),cov=3., n_samples=150, n_features=2, n_classes=3, random_state=47)
X3, y3 = make_gaussian_quantiles(mean=(3,3),cov=2., n_samples=150, n_features=2, n_classes=2, random_state=37)
...
cmap_light = ListedColormap(['#FFAAAA', '#AAFFAA', '#AAAAFF', '#BCB956'])
cmap_bold = ListedColormap(['#FF0000', '#00FF00', '#0000FF', '#BCB956'])
